...
static _Float16
    _TG_ATTRS
    __tg_sqrt(_Float16 __x) {return sqrtf16(__x);}
...
static _Float16
    _TG_ATTRS
    __tg_fabs(_Float16 __x) {return fabsf16(__x);}
...
static _Float16
    _TG_ATTRS
    __tg_ceil(_Float16 __x) {return ceilf16(__x);}
...
static _Float16
    _TG_ATTRS
    __tg_copysign(_Float16 __x, _Float16 __y) {return copysignf16(__x, __y);}
...
static _Float16
    _TG_ATTRS
    __tg_floor(_Float16 __x) {return floorf16(__x);}
...
static _Float16
    _TG_ATTRS
    __tg_fmax(_Float16 __x, _Float16 __y) {return fmaxf16(__x, __y);}
...
static _Float16
    _TG_ATTRS
    __tg_fmin(_Float16 __x, _Float16 __y) {return fminf16(__x, __y);}
...
static _Float16
    _TG_ATTRS
    __tg_hypot(_Float16 __x, _Float16 __y) {return hypotf16(__x, __y);}
...
static _Float16
    _TG_ATTRS
    __tg_nextafter(_Float16 __x, _Float16 __y) {return nextafterf16(__x, __y);}
...
static _Float16
    _TG_ATTRS
    __tg_rint(_Float16 __x) {return rintf16(__x);}
...
static _Float16
    _TG_ATTRS
    __tg_round(_Float16 __x) {return roundf16(__x);}
...
static _Float16
    _TG_ATTRS
    __tg_trunc(_Float16 __x) {return truncf16(__x);}
