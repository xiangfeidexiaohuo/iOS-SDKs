...
static SIMD_NOINLINE simd_quath simd_quaternion(simd_half3x3 matrix) {
  ...
  if (trace >= 0.0) {
    ...
    _Float16 r = 2*sqrtf16(1 - mat[1][1] - mat[2][2] + mat[0][0]);
    _Float16 rinv = simd_recip(r);
    ...
    _Float16 r = 2*sqrtf16(1 - mat[0][0] - mat[2][2] + mat[1][1]);
    _Float16 rinv = simd_recip(r);
    ...
    _Float16 r = 2*sqrtf16(1 - mat[0][0] - mat[1][1] + mat[2][2]);
    _Float16 rinv = simd_recip(r);
