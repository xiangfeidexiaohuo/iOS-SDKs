...
static _Float16 SIMD_CFUNC simd_precise_length(simd_half2  __x) { return sqrtf16(simd_length_squared(__x)); }
static _Float16 SIMD_CFUNC simd_precise_length(simd_half3  __x) { return sqrtf16(simd_length_squared(__x)); }
static _Float16 SIMD_CFUNC simd_precise_length(simd_half4  __x) { return sqrtf16(simd_length_squared(__x)); }
static _Float16 SIMD_CFUNC simd_precise_length(simd_half8  __x) { return sqrtf16(simd_length_squared(__x)); }
static _Float16 SIMD_CFUNC simd_precise_length(simd_half16 __x) { return sqrtf16(simd_length_squared(__x)); }
static _Float16 SIMD_CFUNC simd_precise_length(simd_half32 __x) { return sqrtf16(simd_length_squared(__x)); }
...
static simd_half2  SIMD_CFUNC simd_refract(simd_half2  __x, simd_half2  __n, _Float16 __eta) {
  ...
  return (__k >= 0.0f16) ? __eta*__x - (__eta*simd_dot(__x,__n) + sqrtf16(__k))*__n : (simd_half2)0.0f16;
}
static simd_half3  SIMD_CFUNC simd_refract(simd_half3  __x, simd_half3  __n, _Float16 __eta) {
  const _Float16 __k = 1.0f16 - __eta*__eta*(1.0f16 - simd_dot(__x,__n)*simd_dot(__x,__n));
  return (__k >= 0.0f16) ? __eta*__x - (__eta*simd_dot(__x,__n) + sqrtf16(__k))*__n : (simd_half3)0.0f16;
}
static simd_half4  SIMD_CFUNC simd_refract(simd_half4  __x, simd_half4  __n, _Float16 __eta) {
  const _Float16 __k = 1.0f16 - __eta*__eta*(1.0f16 - simd_dot(__x,__n)*simd_dot(__x,__n));
  return (__k >= 0.0f16) ? __eta*__x - (__eta*simd_dot(__x,__n) + sqrtf16(__k))*__n : (simd_half4)0.0f16;
}
static simd_float2  SIMD_CFUNC simd_refract(simd_float2  __x, simd_float2  __n, float __eta) {
